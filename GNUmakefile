...
build13: DESTINATION=$(APPDATA)/terraform.d/plugins/$(ZTW_PROVIDER_NAMESPACE)/1.0.0/$(GOOS)_$(GOARCH)
else
build13: DESTINATION=$(HOME)/.terraform.d/plugins/$(ZTW_PROVIDER_NAMESPACE)/1.0.0/$(GOOS)_$(GOARCH)
endif
build13: fmtcheck
	@echo "==> Installing plugin to $(DESTINATION)"
	@mkdir -p $(DESTINATION)
	go build -o $(DESTINATION)/terraform-provider-ztw_v1.0.0
