# Forwarding Gateway Example

This example will show you how to use Terraform to create forwarding gateways available in the Zscaler Cloud and Branch Connector Portal
