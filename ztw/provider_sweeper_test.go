...
func TestRunForcedSweeper(t *testing.T) {
	...
	if os.Getenv("ZTW_ACC_TEST_FORCE_SWEEPERS") == "" || os.Getenv("TF_ACC") == "" {
		t.Skipf("ENV vars %q and %q must not be blank to force running of the sweepers", "ZTW_ACC_TEST_FORCE_SWEEPERS", "TF_ACC")
		return
	}
