...
# ztw_network_service_groups (Data Source)

* [Official documentation](https://help.zscaler.com/cloud-branch-connector/about-network-service-groups)
* [API documentation](https://help.zscaler.com/cloud-branch-connector/network-service-groups)

Use the **ztw_network_service_groups** data source to get information about network service groups available in the Zscaler Cloud and Branch Connector Portal. This data source can then be associated with ZTW traffic forwarding rule.

## Example Usage - Retrieve by Name

```hcl
data "ztw_network_service_groups" "example" {
    name = "example_network_service_group"
}
```
