...
layout: "zscaler"
page_title: "ZTW: activation_status"
description: |-
...
# ztw_activation_status (Data Source)

* [Official documentation](https://help.zscaler.com/cloud-branch-connector/about-activation)
* [API documentation](https://help.zscaler.com/cloud-branch-connector/activation-status)

Use the **ztw_activation_status** data source to get information about the current activation status in the Zscaler Cloud and Branch Connector Portal. This data source provides details about organization and admin activation status.
...
output "org_status" {
  value = data.ztw_activation_status.this.org_edit_status
}
```
