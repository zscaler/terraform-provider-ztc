...
Use the **ztw_traffic_forwarding_log_rule** data source to get information about forwarding log rule available in the Zscaler Cloud and Branch Connector Portal.

## Example Usage - Retrieve by Name

```hcl
data "ztw_traffic_forwarding_log_rule" "example" {
    name = "Rule01"
}
```
