...
# ztw_dns_forwarding_gateway (Data Source)

* [Official documentation](https://help.zscaler.com/cloud-branch-connector/configuring-dns-gateway)
* [API documentation](https://help.zscaler.com/cloud-branch-connector/forwarding-gateways)

Use the **ztw_dns_forwarding_gateway** data source to get information about dns forwarding gateways available in the Zscaler Cloud and Branch Connector Portal. This data source can then be associated with ZTW traffic forwarding rule.

## Example Usage - Retrieve by Name

```hcl
data "ztw_dns_forwarding_gateway" "example" {
