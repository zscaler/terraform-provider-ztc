...
# ztw_traffic_forwarding_dns_rule (Data Source)

* [Official documentation](https://help.zscaler.com/cloud-branch-connector/about-dns-policies)
* [API documentation](https://help.zscaler.com/cloud-branch-connector/about-dns-policies)

Use the **ztw_traffic_forwarding_dns_rule** data source to get information about forwarding dns rule available in the Zscaler Cloud and Branch Connector Portal.

## Example Usage - Retrieve by Name

```hcl
data "ztw_traffic_forwarding_dns_rule" "example" {
