...
layout: "zscaler"
page_title: "ZTW: public_cloud_info"
description: |-
...
# ztw_public_cloud_info (Resource)

* [Official documentation](https://help.zscaler.com/cloud-branch-connector/adding-amazon-web-services-account)
* [API documentation](https://help.zscaler.com/cloud-branch-connector/partner-integrations#/publicCloudInfo-post)

Use the **ztw_public_cloud_info** resource allows the creates a new AWS account with the provided account and region details in the Zscaler Cloud and Branch Connector Portal.
...
**ztw_public_cloud_info** can be imported by using `<CLOUD_ID>` or `<CLOUD_NAME>` as the import ID.

For example:

```shell
terraform import ztw_public_cloud_info.example <rule_id>
```

or

```shell
terraform import ztw_public_cloud_info.example <rule_name>
```